...
router.get('/service_title', ...adminFilter, getAllServiceTitle);
router.get('/service_title/:id', ...adminFilter, getServiceTitleById);
router.post('/service_title', ...adminFilter, createServiceTitle);
router.put('/service_title/:id', ...adminFilter, updateServiceTitle);
router.delete('/service_title/:id', ...adminFilter, deleteServiceTitle);
