...
const ServiceTitle = require('./Service_title');
...
Subcategory.hasMany(ServiceTitle, {
    foreignKey: 'subcategory_id'
});
ServiceTitle.belongsTo(Subcategory, {
    foreignKey: 'subcategory_id'
});

// Service & ServiceTitle
ServiceTitle.hasMany(Service, {
    foreignKey: 'service_title_id'
});
Service.belongsTo(ServiceTitle, {
    foreignKey: 'service_title_id'
});
