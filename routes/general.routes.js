...
router.get('/service_title', getAllAdminServices);
router.get('/service_title/:id', getAdminServiceById);
router.post('/service_title', verifyToken, createAdminService);
router.put('/service_title/:id', verifyToken, updateAdminService);
router.delete('/service_title/:id', verifyToken, deleteAdminService);
